...
%% S-SRR's dimensions
L1=10.8; %length of the outer ring
L2=10.3; %width of the outer ring
G1=1; % width of the outer gap
width_outer=1; %%width outer patch
width_iner=width_outer;
G3=1; %distance between iner and outer
